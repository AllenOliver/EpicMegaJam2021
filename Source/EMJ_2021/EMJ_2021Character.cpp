...
AEMJ_2021Character::AEMJ_2021Character()
{
...
void AEMJ_2021Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AEMJ_2021Character::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AEMJ_2021Character::MoveRight);
	...
	PlayerInputComponent->BindTouch(IE_Released, this, &AEMJ_2021Character::TouchStopped);
...
{
	// If EMJ_2021 is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in EMJ_2021.Build.cs is not automatically propagated
...
void AEMJ_2021Character::MoveForward(float Value)
{
...
void AEMJ_2021Character::MoveRight(float Value)
{
	if ((Controller != nullptr) && (Value != 0.0f))
	{
